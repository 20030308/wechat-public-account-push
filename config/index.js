export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx368394e2f3b5e889",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b643c8f57c46fc75136a6733acc86bf7",
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "dYN0rWKAw_dzVwTVKMoMmHgN_5kAb2kn5ZYP3TaSkNQ",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "烟台",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "灿宝", "year": "2003", "date": "09-08"},
        //{"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
       // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "自己", "year": "2003", "date": "03-08"},
    ...
    },
    {
      ...
      useTemplateId: "IqVLaXMqrxnsqvksE8wulMDd8CGLcn4dg2Ums9Bpugo",
      province: "山东",
      city: "烟台",
      horoscopeDate: '10-03',
      horoscopeDateType: '今日',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "琛哥", "year": "2003", "date": "02-06", isShowAge: true},
   //{"type": "节日", "name": "结婚纪念日", "year": "2020", "date": "09-03"},
    // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
    {"type": "生日", "name": "自己", "year": "2003", "date": "10-03", isShowAge: true},
    //{"type": "节日", "name": "被搭讪纪念日", "year": "2021", "date": "09-01"},
    // 你可以不断按格式往下增加
    // ...
  ],
